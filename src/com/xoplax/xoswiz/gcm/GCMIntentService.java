...
import com.xoplax.xoswiz.api.DeviceFinderService;
import com.xoplax.xoswiz.api.request.SendChannelRequestBody;
import com.xoplax.xoswiz.auth.AuthClient;
import com.xoplax.xoswiz.encryption.ECDHKeyService;
import com.xoplax.xoswiz.gcm.model.EncryptedMessage;
import com.xoplax.xoswiz.gcm.model.GCMessage;
import com.xoplax.xoswiz.gcm.model.PlaintextMessage;
...
public class GCMIntentService extends IntentService implements Response.Listener<Integer>, Response.ErrorListener {
    ...
    protected static final String ACTION_RECEIVE = "com.xoplax.xoswiz.gcm.RECEIVE";
